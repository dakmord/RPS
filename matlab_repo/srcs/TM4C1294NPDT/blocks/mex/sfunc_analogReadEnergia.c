/*
 *   sfunc_analogReadEnergia.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        uint16 y1 = analogReadEnergia(uint8 u1)
 *
...
/*
   ...
   def.SFunctionName = 'sfunc_analogReadEnergia';
   def.OutputFcnSpec = 'uint16 y1 = analogReadEnergia(uint8 u1)';
 ...
 */
#define S_FUNCTION_NAME                sfunc_analogReadEnergia
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "analogReadEnergia", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
