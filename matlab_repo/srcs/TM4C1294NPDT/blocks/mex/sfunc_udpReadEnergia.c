/*
 *   sfunc_udpReadEnergia.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        int32 y1 = udpReadEnergia(uint8 y2[p2], uint32 p1, uint16 p2)
 *
...
/*
   ...
   def.SFunctionName = 'sfunc_udpReadEnergia';
   def.OutputFcnSpec = 'int32 y1 = udpReadEnergia(uint8 y2[p2], uint32 p1, uint16 p2)';
 ...
 */
#define S_FUNCTION_NAME                sfunc_udpReadEnergia
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetOutputPortWidth(S, 1, (int_T) mxGetScalar(ssGetSFcnParam(S, 1)));
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "udpReadEnergia", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
