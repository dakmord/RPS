/*
 *   sfunc_digitalReadEnergia.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        uint8 y1 = digitalReadEnergia(uint8 u1, uint8 u2)
 *
...
/*
   ...
   def.SFunctionName = 'sfunc_digitalReadEnergia';
   def.OutputFcnSpec = 'uint8 y1 = digitalReadEnergia(uint8 u1, uint8 u2)';
 ...
 */
#define S_FUNCTION_NAME                sfunc_digitalReadEnergia
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "digitalReadEnergia", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath
                 (S));
  }
