/*
 *   sfcn_serialWriteEnergia.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        void serialWriteEnergia(int16 u3, uint8 u1[], int16 u2)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 24-Jun-2015 19:42:59
...
/*
   ...
   def.SFunctionName = 'sfcn_serialWriteEnergia';
   def.OutputFcnSpec = 'void serialWriteEnergia(int16 u3, uint8 u1[], int16 u2)';
 ...
 */
#define S_FUNCTION_NAME                sfcn_serialWriteEnergia
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "serialWriteEnergia", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath
                 (S));
  }
