/*
 *   sfcn_analogWriteEnergia.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        void analogWriteEnergia(uint8 p1, uint8 u1)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 21-Jun-2015 21:43:21
...
/*
   ...
   def.SFunctionName = 'sfcn_analogWriteEnergia';
   def.OutputFcnSpec = 'void analogWriteEnergia(uint8 p1, uint8 u1)';
 ...
 */
#define S_FUNCTION_NAME                sfcn_analogWriteEnergia
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "analogWriteEnergia", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath
                 (S));
  }
