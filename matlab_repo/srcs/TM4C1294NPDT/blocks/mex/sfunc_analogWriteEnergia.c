/*
 *   sfunc_analogWriteEnergia.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        analogWriteEnergia(uint8 u1, uint8 u2)
 *
...
/*
   ...
   def.SFunctionName = 'sfunc_analogWriteEnergia';
   def.OutputFcnSpec = 'analogWriteEnergia(uint8 u1, uint8 u2)';
 ...
 */
#define S_FUNCTION_NAME                sfunc_analogWriteEnergia
