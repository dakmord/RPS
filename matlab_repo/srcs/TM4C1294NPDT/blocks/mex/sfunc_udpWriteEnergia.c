/*
 *   sfunc_udpWriteEnergia.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        udpWriteEnergia(uint8 u1[], uint32 u2, uint32 p1, uint32 p2, uint8 p3, uint8 p4, uint8 p5 uint8 p6)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 07-May-2015 14:39:55
...
/*
   ...
   def.SFunctionName = 'sfunc_udpWriteEnergia';
   def.OutputFcnSpec = 'udpWriteEnergia(uint8 u1[], uint32 u2, uint32 p1, uint32 p2, uint8 p3, uint8 p4, uint8 p5 uint8 p6)';
   def.HeaderFiles = {'ethernetEnergia.h'};
   def.SourceFiles = {'ethernetEnergia.c'};
 ...
 */
#define S_FUNCTION_NAME                sfunc_udpWriteEnergia
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "udpWriteEnergia", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
 ...
 */
udpWriteEnergia( u1, *u2, *p1, *p2, *p3, *p4, *p5, *p6);
}
