/*
 *   sfunc_digitalWriteEnergia.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        digitalWriteEnergia(uint8 u1, uint8 u2)
 *
...
/*
   ...
   def.SFunctionName = 'sfunc_digitalWriteEnergia';
   def.OutputFcnSpec = 'digitalWriteEnergia(uint8 u1, uint8 u2)';
 ...
 */
#define S_FUNCTION_NAME                sfunc_digitalWriteEnergia
