...
<xsl:template name="header">
    <div class="header"><div class="left">
        <xsl:value-of select="concat(substring-before(m-file,'_doc'),'')" />
    </div>
        <div class="right">
            <a><xsl:attribute name="href"><xsl:value-of select="concat('matlab:',substring-before(m-file,'_doc'))"/></xsl:attribute>
                Open this model
            </a>
            <!--<xsl:value-of select="concat('&lt;a href=',m-file,'&gt;Open this model&lt;/a&gt;')" />
            <a href="matlab:arduinomega2560_servocontrol_sweep">Open this model</a>-->
        </div>
    </div>
</xsl:template>
...
<xsl:template name="footer">
    <p class="footer">
     ...
     <br />
        Stellaris Launchpad Support Package is written by Sippey. <a href="mailto:sippey@gmail.com">(send mail)</a>
    </p>
