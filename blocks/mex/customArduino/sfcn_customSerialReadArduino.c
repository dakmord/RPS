/*
 *   sfcn_customSerialReadArduino.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        void Serial_Read_Arduino(int32 p1, uint8 y1[p2], int32 y2[1], int32 p2)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C source code generated on : 26-May-2015 21:22:01
...
/*
   ...
   def.SFunctionName = 'sfcn_customSerialReadArduino';
   def.OutputFcnSpec = 'void Serial_Read_Arduino(int32 p1, uint8 y1[p2], int32 y2[1], int32 p2)';
   def.HeaderFiles = {'customArduino.h'};
   def.SourceFiles = {'customArduino.c'};
   def.IncPaths = {'C:\Users\q365198\Rapid-Prototyping-System\blocks\src\customArduino\'};
   def.SrcPaths = {'C:\Users\q365198\Rapid-Prototyping-System\blocks\src\customArduino\'};
 ...
 */
#define S_FUNCTION_NAME                sfcn_customSerialReadArduino
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetOutputPortWidth(S, 0, (int_T) mxGetScalar(ssGetSFcnParam(S, 1)));
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Serial_Read_Arduino", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath
                 (S));
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   */
  Serial_Read_Arduino( *p1, y1, y2, *p2);
}
